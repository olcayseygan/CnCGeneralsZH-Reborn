...
#define CHECK_IF(x) if (t == x) { return #x; }
  ...
  CHECK_IF(MSG_META_DEBUG_SHOW_AUDIO_LOCATIONS)
	...
	CHECK_IF(MSG_META_SIGNAL_ATTACK)
	CHECK_IF(MSG_META_SIGNAL_DEFEND)
	CHECK_IF(MSG_META_SIGNAL_ATTENTION)
	...
	CHECK_IF(MSG_BEGIN_AREA_SELECTION_HINT)
	CHECK_IF(MSG_END_AREA_SELECTION_HINT)
	...
	CHECK_IF(MSG_AREA_SELECTION_DEPRECATED)
	...
	CHECK_IF(MSG_DO_FORMATION_MOVETO)
	CHECK_IF(MSG_DO_FORMATION_ATTACKMOVETO)
	CHECK_IF(MSG_DO_FORMATION_FORCEATTACK)
	CHECK_IF(MSG_DO_FORMATION_GUARD)
	CHECK_IF(MSG_PLACE_SIGNAL)
