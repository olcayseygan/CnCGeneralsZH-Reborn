...
public:
	...
	enum Type
	{
		...
		MSG_RAW_MOUSE_WHEEL,												///< (Real spin in notches, + is away, - is toward user)
		MSG_RAW_MOUSE_END,
    ...
    MSG_META_DEBUG_SHOW_HEALTH,									///< show object health
		...
		MSG_END_AREA_SELECTION_HINT,								///< (pixelRegion) that rectangle is finished
...
//*********************************************************************************************************
		...
		MSG_AREA_SELECTION_DEPRECATED,							///< was a network message and never needed to be one; the two hints above carry it now
