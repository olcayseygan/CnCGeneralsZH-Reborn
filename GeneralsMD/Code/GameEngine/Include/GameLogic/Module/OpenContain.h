...
private:
	...
	UnsignedInt					m_heroUnitsContained;						///< how many heroes are inside, kept as a count so isHero costs nothing
	XferVersion					m_xferVersion;									///< which save version was loaded, for loadPostProcess
